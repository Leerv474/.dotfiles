...
M.on_attach = function(client, bufnr)
	...
	vim.keymap.set("n", "gd", vim.lsp.buf.definition, vim.tbl_extend("force", bufopts, { desc = "List definitions" }))
	vim.keymap.set(
		"n",
		"gi",
	...
	vim.keymap.set("n", "<leader>rr", vim.lsp.buf.rename, vim.tbl_extend("force", bufopts, { desc = "Smart rename" }))
	-- vim.keymap.set(
	-- 	"n",
	-- 	"<leader>d",
